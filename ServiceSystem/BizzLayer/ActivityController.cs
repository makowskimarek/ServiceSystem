                ...
                using (ServiceSystemDataContext dbContext = new ServiceSystemDataContext())
                {
                    try
                    {
                        ...
                        if (activities.Count() > 0)
                        {
                            ...
                            {
                                activities = activities.Where(a => a.nameC == srchCriteria.nameC);
                            }
                            if (srchCriteria.fnameC.Length != 0)
                            {
                                activities = activities.Where(a => a.fnameC == srchCriteria.fnameC);
                            }
                            if (srchCriteria.lnameC.Length != 0)
                            {
                                activities = activities.Where(a => a.lnameC == srchCriteria.lnameC);
                            }
                            if (srchCriteria.lnameW.Length != 0)
                            {
                                activities = activities.Where(a => a.lnameW == srchCriteria.lnameW);
                            }
                            if (srchCriteria.fnameW.Length != 0)
                            {
                                activities = activities.Where(a => a.fnameW == srchCriteria.fnameW);
                            }
                            if (srchCriteria.name_type.Length != 0)
                            {
                                activities = activities.Where(a => a.name_type == srchCriteria.name_type);
                            }
                            ...
                            foreach (var actResult in activitiesResult)
                            {
                                ...
                                act.wrk_id = actResult.id_wrk;
                                act.code_type = actResult.code;
                                act.act_type = actResult.act_type;
                                act.sequence = actResult.seq_no;
                                act.description = actResult.descr;
                                ...
                                act.fname = actResult.fnameC;
                                act.lname = actResult.lnameC;
                                act.name = actResult.nameC;
                                act.fnameW = actResult.fnameW;
                                act.lnameW = actResult.lnameW;
